...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('brands', function (Blueprint $table) {
            ...
            $table->text('product_content')->nullable()->after('brand_description');
            $table->string('subject_category')->nullable()->after('campaign_title');
            $table->json('product_images')->nullable()->after('logo');
            ...
            $table->text('rules')->nullable()->after('campaign_description');
        });
    }
    ...
    public function down(): void
    {
        Schema::table('brands', function (Blueprint $table) {
            $table->dropColumn([
                'slug', 'contact_email', 'phone', 'product_brand', 'product_category',
                'tags', 'product_content', 'subject_category', 'product_images',
                'other_files', 'campaign_image', 'slogan', 'image_description',
                'creative_assets', 'campaign_goal', 'audience_location', 'start_date',
                'end_date', 'prize_type', 'prize_amount', 'winner_selection', 'rules'
            ]);
        });
    }
};
