<x-app-layout>
                ...
                <div class="p-4 sm:p-8">
                    <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Drafts are only visible to you. Published blogs are visible to everyone.
                            </p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div id="app_links_container" class="space-y-3">
                                @if(old('app_links'))
                                    @foreach(old('app_links') as $index => $oldLink)
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="{{ route('blogs.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg transition text-center w-full sm:w-auto">
                                Cancel
                            </a>
                        </div>
                    </form>
    ...
    <script>
        ...
        // App link counter
        let appLinkCount = {{ old('app_links') ? count(old('app_links')) : 0 }};
