...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div id="date-validation-popup" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
            <div class="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl transform transition-all relative">
                <!-- Close Button -->
                <button onclick="document.getElementById('date-validation-popup').classList.add('hidden')" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition-colors">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Dates Already Selected</h3>
                    <p class="text-gray-600 mb-4">The selected dates are already chosen by another campaign.</p>
                    
                    <div id="conflicting-campaign-info" class="bg-gray-50 rounded-lg p-4 mb-6 text-left hidden">
                        <p class="text-sm text-gray-600 mb-2">Conflicting Campaign:</p>
                        <p class="text-sm font-semibold text-gray-900" id="conflict-company"></p>
                        <p class="text-xs text-gray-500 mt-1" id="conflict-dates"></p>
                    </div>
        ...
        <div class="mb-8 text-center relative">
            ...
            <!-- OneDollarMeme Logo -->
            <div class="mb-4">
                <img src="{{ asset('image/my-logo.jpg') }}" alt="OneDollarMeme" class="mx-auto" style="width: 80px; height: 80px; object-fit: cover;">
            </div>
        ...
        <!-- ========== STEP 1: Brand Account ========== -->
            <div id="step-1" class="step-content bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
                ...
                <!-- Step 1 Error Box -->
                <div id="step-1-error" class="mb-6 bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3 hidden">
                    <svg class="w-6 h-6 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <div>
                        <p class="text-red-800 font-bold">Incomplete Information</p>
                        <p class="text-red-700 text-sm" id="step-1-error-msg">Please fill in all required fields marked with *</p>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid md:grid-cols-1 gap-4">
                        <div>
                            ...
                            <div id="company_name-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                                ...
                                <span class="text-xs text-red-700 font-medium">Brand Name is required</span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div id="contact_email-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                                <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                <span class="text-xs text-red-700 font-medium" id="contact_email-error-text">Contact Email is required</span>
                            </div>
                    ...
                    <!-- Brand Logo Upload (Moved after Website & Tags) -->
                    <div class="mt-6">
                        <label class="block text-sm font-semibold text-gray-700 mb-2 text-center">Brand Logo</label>
                        <div class="flex flex-col items-center justify-center gap-3">
                            <div class="group relative">
                                <div class="w-64 h-100 relative rounded-xl shadow-md overflow-hidden bg-gray-50 border-2 border-dashed border-gray-300 hover:border-purple-500 hover:bg-purple-50 transition cursor-pointer" onclick="document.getElementById('brand_logo_input').click()">
                                    <img id="logo-preview-img" src="{{ asset('WhatsApp Image 2026-02-12 at 12.16.49 PM.jpeg') }}" alt="Brand Logo" class="w-full h-full object-contain">
                            ...
                            <div class="text-center">
                                ...
                                <button type="button" class="btn-sm bg-purple-50 text-purple-700 px-6 py-2 rounded-lg font-semibold hover:bg-purple-100 transition" onclick="document.getElementById('brand_logo_input').click()">
                                    Upload Logo
                                </button>
                                <p class="text-xs text-gray-500 mt-2">Recommended: 500x500px PNG or JPG</p>
                            </div>
                        </div>
                    </div>
            ...
            <div id="step-2" class="step-content hidden bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
                ...
                <!-- Step 2 Error Box -->
                <div id="step-2-error" class="mb-6 bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3 hidden">
                    <svg class="w-6 h-6 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <div>
                        <p class="text-red-800 font-bold">Incomplete Information</p>
                        <p class="text-red-700 text-sm" id="step-2-error-msg">Please fill in all required fields marked with *</p>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div id="campaign_title-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="text-xs text-red-700 font-medium">Campaign Title is required</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            required></textarea>
                        <div id="product_content-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="text-xs text-red-700 font-medium">Product Description is required</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div id="start_date-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                                    <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    <span class="text-xs text-red-700 font-medium">Start Date is required</span>
                                </div>
                            ...
                            <div>
                                <input
                                    ...
                                    onchange="validateDates()">
                                <div id="end_date-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                                    <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    <span class="text-xs text-red-700 font-medium" id="end_date-error-text">End Date is required</span>
                                </div>
            ...
            <div id="step-3" class="step-content hidden bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
                ...
                <!-- Step 3 Error Box -->
                <div id="step-3-error" class="mb-6 bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3 hidden">
                    <svg class="w-6 h-6 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <div>
                        <p class="text-red-800 font-bold">Incomplete Information</p>
                        <p class="text-red-700 text-sm" id="step-3-error-msg">Please fill in all required fields marked with *</p>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div id="campaign_goal-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="text-xs text-red-700 font-medium">Campaign Goal is required</span>
                        </div>
                        <input
                            type="text"
                    ...
                    <div>
                        ...
                        <div id="prize_type-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="text-xs text-red-700 font-medium">Reward Type is required</span>
                        </div>
                        <input
                            type="text"
                    ...
                    <div>
                        ...
                        <div id="audience_location-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                            <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <span class="text-xs text-red-700 font-medium">Audience Region is required</span>
                        </div>
                        <input
                            type="text"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                required
                                oninput="validateBudgetCustom(this); updateBudgetBreakdown()">
                        </div>
                        <!-- Custom Budget Error Card -->
                        <div id="budget-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-3 flex items-center gap-2 hidden">
                            <svg class="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <span class="text-sm text-red-700 font-medium">Minimum prize budget is <strong>$100</strong>. Please enter $100 or more.</span>
                        </div>
                        <p class="text-xs text-gray-500 mt-1">Minimum prize budget: $100</p>
                    </div>

                    <script>
                    function validateBudgetCustom(input) {
                        const errorCard = document.getElementById('budget-error-card');
                        const val = parseFloat(input.value);
                        if (input.value !== '' && (isNaN(val) || val < 100)) {
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-purple-400 transition cursor-pointer" onclick="document.getElementById('product_images').click()">
                                        ...
                                        <input type="file" name="product_images[]" id="product_images" class="hidden" accept="image/*" multiple onchange="previewMultipleFiles(event, 'product-images-preview', 5); document.getElementById('product_images-error-card').classList.add('hidden')">
                                    </div>
                                    <div id="product_images-error-card" class="mt-2 bg-red-50 border border-red-200 rounded-lg p-2 flex items-center gap-2 hidden">
                                        <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                        <span class="text-xs text-red-700 font-medium">At least one campaign image is required</span>
                                    </div>
                        ...
                        <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="border-t border-gray-200 pt-6">
                                    ...
                                    <div id="review-campaign-images" class="grid grid-cols-2 md:grid-cols-5 gap-4">
                                        <p class="text-gray-500 text-sm col-span-2 md:col-span-5">Images will appear here after upload</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
                            <label class="flex items-start gap-3 cursor-pointer">
                                <input type="checkbox" name="terms_accepted" id="terms_accepted" value="1" class="mt-1 w-5 h-5 rounded border-gray-300 text-purple-600 focus:ring-purple-500" onchange="this.checked ? document.getElementById('terms-error-card').classList.add('hidden') : null">
                            ...
                            <!-- Custom Terms Error Card -->
                            <div id="terms-error-card" class="mt-4 bg-red-50 border border-red-200 rounded-lg p-3 flex items-center gap-2 hidden">
                                <svg class="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <span class="text-sm text-red-700 font-medium">Please accept the Terms of Service and Content Guidelines to continue.</span>
                            </div>
                        </div>
                    </div>
...
async function validateDates() {
    ...
    try {
        const response = await fetch('{{ route("brands.check-dates") }}', {
            method: 'POST',
            headers: {
...
function validateCurrentStep() {
    let isValid = true;
    let errors = [];
    const mainErrorBox = document.getElementById(`step-${currentStep}-error`);
    const mainErrorMsg = document.getElementById(`step-${currentStep}-error-msg`);

    // Helper to add error
    const markError = (id, msg, customTextId = null) => {
        isValid = false;
        errors.push(msg);
        
        const input = document.getElementById(id);
        const card = document.getElementById(`${id}-error-card`);
        const textElement = customTextId ? document.getElementById(customTextId) : null;
        ...
        if (input) {
            ...
            // Add listener to clear error
            const clearError = () => {
                input.classList.remove('border-red-500', 'bg-red-50');
                input.classList.add('border-gray-300');
                if (card) card.classList.add('hidden');
                
                // Also check if any other errors remain to hide main box
                setTimeout(() => {
                    const activeCards = document.querySelectorAll(`.step-content:not(.hidden) [id$="-error-card"]:not(.hidden)`);
                    if (activeCards.length === 0 && mainErrorBox) mainErrorBox.classList.add('hidden');
                }, 100);
    ...
    if (currentStep === 1) {
        if (!document.getElementById('company_name').value.trim()) markError('company_name', 'Brand Name is required');
        const email = document.getElementById('contact_email').value.trim();
        if (!email) {
            markError('contact_email', 'Contact Email is required', 'contact_email-error-text');
        } else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
            markError('contact_email', 'Please enter a valid email address', 'contact_email-error-text');
        }

    } else if (currentStep === 2) {
        if (!document.getElementById('campaign_title').value.trim()) markError('campaign_title', 'Campaign Title is required');
        if (!document.getElementById('product_content').value.trim()) markError('product_content', 'Product Description is required');
        if (!document.getElementById('start_date').value) markError('start_date', 'Start Date is required');
        if (!document.getElementById('end_date').value) {
            markError('end_date', 'End Date is required', 'end_date-error-text');
        }

        const startDate = document.getElementById('start_date').value;
        const endDate = document.getElementById('end_date').value;
        if (startDate && endDate && new Date(startDate) >= new Date(endDate)) {
            markError('end_date', 'End date must be after start date', 'end_date-error-text');
        }

    } else if (currentStep === 3) {
        if (!document.getElementById('campaign_goal').value) markError('campaign_goal', 'Campaign Goal is required');
        if (!document.getElementById('prize_type').value) markError('prize_type', 'Reward Type is required');
        if (!document.getElementById('audience_location').value) markError('audience_location', 'Audience Region is required');
        
        const budgetInput = document.getElementById('prize_amount');
        const budget = parseFloat(budgetInput.value);
        if (!budgetInput.value.trim()) {
            markError('prize_amount', 'Total Budget is required');
            // This field uses id="budget-error-card" instead of prize_amount-error-card
            const bCard = document.getElementById('budget-error-card');
            if (bCard) bCard.classList.remove('hidden');
        } else if (budget < 100) {
            markError('prize_amount', 'Minimum budget is $100');
            const bCard = document.getElementById('budget-error-card');
            if (bCard) bCard.classList.remove('hidden');
        }

        if (document.getElementById('campaign_goal').value === 'Other' && !document.getElementById('campaign_goal_other').value.trim()) {
            markError('campaign_goal_other', 'Please specify your campaign goal');
        }
        if (document.getElementById('prize_type').value === 'Other' && !document.getElementById('prize_type_other').value.trim()) {
            markError('prize_type_other', 'Please specify your reward type');
        }
        if (document.getElementById('audience_location').value === 'Other' && !document.getElementById('audience_location_other').value.trim()) {
            markError('audience_location_other', 'Please specify your target region');
        }
    }

    if (!isValid && mainErrorBox && mainErrorMsg) {
        mainErrorMsg.innerHTML = 'Some required information is missing. Please check the highlighted fields below.';
        mainErrorBox.classList.remove('hidden');
        mainErrorBox.scrollIntoView({ behavior: 'smooth', block: 'center' });
    } else if (mainErrorBox) {
        mainErrorBox.classList.add('hidden');
    }
...
function updateReviewStep() {
    ...
    // Campaign Images - Display uploaded images in review section
    const productImagesInput = document.getElementById('product_images');
    const reviewImagesContainer = document.getElementById('review-campaign-images');
        ...
        Array.from(productImagesInput.files).forEach((file) => {
            if (file.type.startsWith('image/')) {
                ...
                reader.onload = function(e) {
                    ...
                    `;
                    reviewImagesContainer.appendChild(div);
                }
                reader.readAsDataURL(file);
            }
        });
    } else {
        reviewImagesContainer.innerHTML = '<p class="text-gray-500 text-sm col-span-2 md:col-span-5">No images uploaded yet</p>';
    }
...
function openPaymentModal() {
    ...
    if (!images.files || images.files.length === 0) {
        const imgError = document.getElementById('product_images-error-card');
        imgError.classList.remove('hidden');
        imgError.scrollIntoView({ behavior: 'smooth', block: 'center' });
        return;
    }

    // Check terms acceptance
    if (!document.getElementById('terms_accepted').checked) {
        const termsError = document.getElementById('terms-error-card');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (draft.brand_logo) {
        ...
        if (logoPreview) {
            logoPreview.src = '/storage/' + draft.brand_logo;
        }
    }
